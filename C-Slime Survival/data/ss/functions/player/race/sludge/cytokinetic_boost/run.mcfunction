...
execute if score max_health temp matches 4.. run attribute @s minecraft:generic.movement_speed modifier add 7091ceff-ec6a-4c0a-ad14-bbbe10434664 "cytokinetic_boost" 1.0 multiply_base
