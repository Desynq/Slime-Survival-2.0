item replace block 0 0 1 container.0 with minecraft:golden_pickaxe{Tags:["clear"],type:"attack_speed_attribute_button",display:{Name:'{"italic":false,"color":"dark_red","text":"Attack Speed Attribute"}',Lore:['{"italic":false,"color":"gold","text":"+0.2 Attack Speed"}','""']},AttributeModifiers:[]}
