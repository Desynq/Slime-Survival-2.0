item replace block 0 0 1 container.0 with minecraft:enchanted_golden_apple{Tags:["clear"],type:"max_health_attribute_button",display:{Name:'{"italic":false,"color":"dark_red","text":"Max Health Attribute"}',Lore:['{"italic":false,"color":"gold","text":"+4.0 Max Health"}','""']},AttributeModifiers:[]}
