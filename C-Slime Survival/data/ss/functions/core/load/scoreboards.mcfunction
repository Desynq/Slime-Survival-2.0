...
scoreboard objectives add tempTimer dummy
...
scoreboard objectives add temperature_rate dummy
...
scoreboard objectives add entOwner dummy
scoreboard objectives add entLogged dummy
scoreboard objectives add entX dummy
scoreboard objectives add entY dummy
scoreboard objectives add entZ dummy
scoreboard objectives add entUUID dummy


## Miscellaneous

scoreboard objectives add SteveAI dummy
